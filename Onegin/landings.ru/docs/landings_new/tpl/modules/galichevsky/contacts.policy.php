<?if(!$is_robot){?>
	<noindex>
		...
		<div id="policy_win">
			...
			<p>Администрация сайта <span>галичевский.рф</span> (далее Сайт) с
			...
			<ul>
				...
				<li>предоставить возможность для приобретения книги "Банкротство физического лица (гражданина).
				Все, что нужно знать должнику и кредитору".</li>
			</ul>
